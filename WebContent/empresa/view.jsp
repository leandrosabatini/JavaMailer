    ...
    <div class="container-fluid display-table" style="padding: 0;">
        <div class="row display-table-row" style="height: 100vh;">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="/Mailer/empresa/view.jsp"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Empresa</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <c:import url="/Mailer/TopMenu.jsp"/>
                
                <div class="user-dashboard">
                    <h1><%= empresa.getNome() %> <a href="Empresa.do?action=edit"><i class="fa fa-edit"></i></a></h1>
                    <div class="row">
                    </div>
                </div>
            </div>
