            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="cliente-dashboard">
                	<div class="col-12" style="margin: 20px 0px;">
                    	<span class="h1">Editar empresa</span>
                    </div>
                    <div class="col-12">
						<div class="">
							<form action="/Mailer/controller.do" method="POST">
								<input class="hidden" type="text" name="id" value='${empresa.id }'>
								<input class="hidden" type="text" name="command" value="EditarEmpresa">
								<div class="form-group">
							    	<label for="nome">Nome</label>
							    	<input type="text" value='${empresa.nome }' class="form-control" name="nome" id="nome" placeholder="Insira o nome da sua empresa">
							  	</div>
							  	<div class="form-group">
