	...
	<div class="wrapper fadeInDown">
	  <div id="formContent">
	    ...
	    <form action="controller.do" method="POST">
	      ...
	      <input type="password" id="password" class="fadeIn third" name="senha" required placeholder="Senha">
	      <input type="submit" name="command" value="FazerLogin" class="hidden">
	      <input type="submit" class="fadeIn fourth" value="Login">
	    </form>
	
		<div id="formFooter" style="font-size: 15px;"	>
	      <a class="underlineHover" class="mb-3" href="forgot.jsp">Esqueci a senha</a><br><br>
	      <a class="underlineHover" href="register.jsp">Criar conta</a>
	    </div>
